...
class VizituController extends Controller
{
    /**
    ...
    {
        $Information[]= $_GET ;
        $Info = VizituModel::where('fullinfoid',$Information[0]["fullinfoid"])
    ...
    {
        VizituModel::create($request->all());
    ...
    {
        VizituModel::where('fullinfoid', $request->input('fullinfoid'))
